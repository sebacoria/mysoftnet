...
/**
 * Java model for the Force.com CollaborationGroupFeed object.
 *
...
@Table(name="CollaborationGroupFeed")
@Entity(name="CollaborationGroupFeed")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class CollaborationGroupFeed extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected CollaborationGroup parent;
    ...
    public CollaborationGroup getParent() {
        return this.parent;
    }
    
    @Basic(optional=false)
    public void setParent(CollaborationGroup parent) {
        this.parent = parent;
    }
