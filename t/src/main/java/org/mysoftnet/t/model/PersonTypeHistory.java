...
/**
 * Java model for the Force.com PersonType__History object.
 *
...
@Table(name="PersonType__History")
@Entity(name="PersonTypeHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class PersonTypeHistory extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected boolean isDeleted;
    protected PersonType parent;
    ...
    public void setParent(PersonType parent) {
        this.parent = parent;
    }
    ...
    public enum FieldEnum implements com.force.sdk.jpa.model.PicklistValueEnum {
        ...
        CODE__C(true,false,null,"Code__c"),
        CREATED(true,false,"Created.","created"),
        DESCRIPTION__C(true,false,null,"Description__c"),
