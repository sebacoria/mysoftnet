...
/**
 * Java model for the Force.com MapLocation__History object.
 *
...
@Table(name="MapLocation__History")
@Entity(name="MapLocationHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class MapLocationHistory extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected boolean isDeleted;
    protected MapLocation parent;
