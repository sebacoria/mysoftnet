...
/**
 * Java model for the Force.com Map__History object.
 *
...
@Table(name="Map__History")
@Entity(name="MapHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class MapHistory extends com.force.sdk.jpa.model.BaseForceObject {
