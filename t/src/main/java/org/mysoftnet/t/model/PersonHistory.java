...
/**
 * Java model for the Force.com Person__History object.
 *
...
@Table(name="Person__History")
@Entity(name="PersonHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class PersonHistory extends com.force.sdk.jpa.model.BaseForceObject {
    ...
    public enum FieldEnum implements com.force.sdk.jpa.model.PicklistValueEnum {
        ...
        FIRSTNAME__C(true,false,null,"FirstName__c"),
        LASTNAME__C(true,false,null,"LastName__c"),
        LOCATION__C(true,false,null,"Location__c"),
