...
/**
 * Java model for the Force.com MapAreaPoint__History object.
 *
...
@Table(name="MapAreaPoint__History")
@Entity(name="MapAreaPointHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class MapAreaPointHistory extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected boolean isDeleted;
    protected MapAreaPoint parent;
    ...
    public MapAreaPoint getParent() {
        return this.parent;
    }
    
    @Basic(optional=false)
    public void setParent(MapAreaPoint parent) {
        this.parent = parent;
    }
    ...
    public enum FieldEnum implements com.force.sdk.jpa.model.PicklistValueEnum {
        ...
        XCOORDINATE__C(true,false,null,"XCoordinate__c"),
        YCOORDINATE__C(true,false,null,"YCoordinate__c"),
        ;
