...
/**
 * Java model for the Force.com CongregationPersonAssigment__History object.
 *
...
@Table(name="CongregationPersonAssigment__History")
@Entity(name="CongregationPersonAssigmentHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class CongregationPersonAssigmentHistory extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected boolean isDeleted;
    protected CongregationPersonAssigment parent;
    ...
    public CongregationPersonAssigment getParent() {
        return this.parent;
    }
    
    @Basic(optional=false)
    public void setParent(CongregationPersonAssigment parent) {
        this.parent = parent;
    }
