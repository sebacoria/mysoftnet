...
/**
 * Java model for the Force.com CongregationPersonAssigment__c object.
 *
...
@Table(name="CongregationPersonAssigment__c")
@Entity(name="CongregationPersonAssigment")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class CongregationPersonAssigment extends com.force.sdk.jpa.model.BaseForceCustomObject {

    public static final String KEY_PREFIX = "a08";
