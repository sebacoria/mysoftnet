...
/**
 * Java model for the Force.com MapArea__History object.
 *
...
@Table(name="MapArea__History")
@Entity(name="MapAreaHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class MapAreaHistory extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected boolean isDeleted;
    protected MapArea parent;
    ...
    public void setParent(MapArea parent) {
        this.parent = parent;
    }
