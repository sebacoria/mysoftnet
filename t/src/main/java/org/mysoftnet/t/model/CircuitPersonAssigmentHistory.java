...
/**
 * Java model for the Force.com CircuitPersonAssigment__History object.
 *
...
@Table(name="CircuitPersonAssigment__History")
@Entity(name="CircuitPersonAssigmentHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class CircuitPersonAssigmentHistory extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected boolean isDeleted;
    protected CircuitPersonAssigment parent;
    ...
    public CircuitPersonAssigment getParent() {
        return this.parent;
    }
    
    @Basic(optional=false)
    public void setParent(CircuitPersonAssigment parent) {
        this.parent = parent;
    }
