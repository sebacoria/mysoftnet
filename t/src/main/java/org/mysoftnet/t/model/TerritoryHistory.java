...
/**
 * Java model for the Force.com Territory__History object.
 *
...
@Table(name="Territory__History")
@Entity(name="TerritoryHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class TerritoryHistory extends com.force.sdk.jpa.model.BaseForceObject {
