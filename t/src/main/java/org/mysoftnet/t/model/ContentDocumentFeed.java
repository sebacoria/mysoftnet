...
/**
 * Java model for the Force.com ContentDocumentFeed object.
 *
...
@Table(name="ContentDocumentFeed")
@Entity(name="ContentDocumentFeed")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class ContentDocumentFeed extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "";


    protected ContentDocument parent;
    ...
    public ContentDocument getParent() {
        return this.parent;
    }
    
    @Basic(optional=false)
    public void setParent(ContentDocument parent) {
        this.parent = parent;
    }
