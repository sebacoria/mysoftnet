...
/**
 * Java model for the Force.com UserProfileFeed object.
 *
...
@Table(name="UserProfileFeed")
@Entity(name="UserProfileFeed")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class UserProfileFeed extends com.force.sdk.jpa.model.BaseForceObject {

    public static final String KEY_PREFIX = "0D5";
