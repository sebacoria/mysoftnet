...
/**
 * Java model for the Force.com Circuit__History object.
 *
...
@Table(name="Circuit__History")
@Entity(name="CircuitHistory")
@com.force.sdk.jpa.annotation.CustomObject(readOnlySchema=true)
public class CircuitHistory extends com.force.sdk.jpa.model.BaseForceObject {
    ...
    public enum FieldEnum implements com.force.sdk.jpa.model.PicklistValueEnum {
        ...
        PART__C(true,false,null,"Part__c"),
